...
citing `DSM/PI_OF_NL_EV_IMPLEMENTATION.md`.
...
makes project-file parsing fail with an error citing
`DSM/PI_OF_NL_EV_IMPLEMENTATION.md §3 mode matrix`. The combination predicate
