# DSM Verification Ramps — single-element saturation/desaturation

OGS single-element replacement for the Gauss-point Jupyter notebook
`tex/cc2024/examples/DSM/Potentials_penalty.ipynb`. Runs a triangle
saturation+desaturation ramp at the three Model-I-calibrated dry densities
(1400, 1600, 1800 kg/m³) using the native DSM hierarchical implementation.
